...
import { DenoLoggerAdapter } from './adapter-files/logger-adapter';
const logger = new DenoLoggerAdapter('01-adapter.ts');

logger.writeLog('Mensaje de un log normal');
logger.writeError('Mensaje de un log de error');
logger.writeWarning('Mensaje de un log de advertencia');
